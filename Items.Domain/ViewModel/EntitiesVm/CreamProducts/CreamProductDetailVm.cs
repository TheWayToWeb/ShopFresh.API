...
namespace Items.Domain.ViewModel.EntitiesVm.CreamProducts
{
    public class CreamProductDetailVm : IMapWith<CreamProduct>
    {
        ...
        {
            profile.CreateMap<CreamProduct, CreamProductDetailVm>()
