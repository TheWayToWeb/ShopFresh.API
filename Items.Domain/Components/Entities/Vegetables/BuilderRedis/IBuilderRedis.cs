using Items.Domain.Components.Entities.Vegetables.BuilderRedis.Redis;
using Items.Domain.Components.Entities.Vegetables.Vegetable;
using RedisConcrete = Items.Domain.Components.Entities.Vegetables.BuilderRedis.Redis.Redis;
