using SelfRedis = Items.Domain.Components.Entities.Vegetables.BuilderRedis.Redis.Redis;

namespace Items.Domain.Components.Entities.Vegetables.BuilderRedis
{
    public class BuildRedis : IBuilderRedis
    {
        ...
        public BuildRedis(Guid personId, int countInPackage, int createdDate, float weight)
        {
            PersonId = personId;
        ...
        public SelfRedis CreateRedis()
        {
            return new SelfRedis(this);
        }
    }
}
