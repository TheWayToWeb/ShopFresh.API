namespace Items.Domain.Components.Entities.Categories.Bread.MakingCroissant
{
    public class BakeCroissant : BakerCroissant
    {
        ...
        public BakeCroissant() { }

        public BakeCroissant(Guid personId, string? itemName, int price, string? imagePath)
        {
            PersonId = personId;
            ItemId = Guid.NewGuid();
            _itemName = itemName;
        ...
        public override Croissant CreateCroissant()
        {
            return new Croissant(PersonId, ItemId, _itemName, _price, _imagePath);
        }
    }
}
