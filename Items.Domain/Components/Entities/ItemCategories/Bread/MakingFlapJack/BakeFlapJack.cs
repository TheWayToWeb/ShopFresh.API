...
{
    public class BakeFlapJack : MakerFlapJack
    {
        ...
        public BakeFlapJack(Guid personId, string? itemName, int price, string? imagePath)
        {
            PersonId = personId;
            ItemId = Guid.NewGuid();
            _itemName = itemName;
        ...
        public override FlapJack CreateFlapJack()
        {
            return new FlapJack(PersonId, ItemId, _itemName, _price, _imagePath);
        }
    }
}
