...
namespace Items.Domain.Components.Entities.Categories.Drinks.ConcreteDrinkEnergy
{
    ...
    public class MakeDrinkEnergy : IMakerDrinkEnergy
    {
        ...
        public MakeDrinkEnergy() { }

        public MakeDrinkEnergy(Guid personId, string itemName, int price, string imagePath)
        {
            PersonId = personId;
            ItemId = Guid.NewGuid();
