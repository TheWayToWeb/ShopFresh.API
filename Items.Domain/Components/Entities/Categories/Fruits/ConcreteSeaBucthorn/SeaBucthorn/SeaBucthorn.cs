using Items.Domain.Components.Entities.Categories.Fruits.ConcreteSeaBucthorn;
using FruitSelf = Items.Domain.Components.Entities.Categories.Fruits.Fruit.Fruit;

namespace Items.Domain.Components.Entities.Categories.Fruits.ConcreteSeaBucthorn.SeaBucthorn
{
