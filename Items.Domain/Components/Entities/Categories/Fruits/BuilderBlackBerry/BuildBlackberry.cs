using SelfBlackberry = Items.Domain.Components.Entities.Categories.Fruits.BuilderBlackBerry.BlackBerry.Blackberry;

namespace Items.Domain.Components.Entities.Categories.Fruits.BuilderBlackBerry
{
    public class BuildBlackberry : IBuilderBalckberry
    {
        ...
        public BuildBlackberry(Guid personId, int countInPackage, int createdDate, float weight)
        {
            PersonId = personId;
        ...
        public SelfBlackberry CreateBlackberry()
        {
            return new SelfBlackberry(this);
        }
    }
}
