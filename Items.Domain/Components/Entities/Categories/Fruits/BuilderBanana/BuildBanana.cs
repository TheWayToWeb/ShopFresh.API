...
{
    public class BuildBanana : IBuilderBanana
    {
        ...
        public BuildBanana(Guid personId, int countInPackage, int createdDate)
        {
            PersonId = personId;
        ...
        public SelfBanana CreateBanana()
        {
            return new SelfBanana(this);
        }
    }
}
