using Items.Domain.Components.Entities.Categories.Fruits.ConcreteStrawberry;
using FruitSelf = Items.Domain.Components.Entities.Categories.Fruits.Fruit.Fruit;

namespace Items.Domain.Components.Entities.Categories.Fruits.ConcreteStrawberry.Strawberry
{
