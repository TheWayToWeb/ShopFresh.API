using Items.Domain.Components.Entities.Categories.Fruits.ConcreteCitrus;
using FruitSelf = Items.Domain.Components.Entities.Categories.Fruits.Fruit.Fruit;

namespace Items.Domain.Components.Entities.Categories.Fruits.ConcreteCitrus.Citrus
{
