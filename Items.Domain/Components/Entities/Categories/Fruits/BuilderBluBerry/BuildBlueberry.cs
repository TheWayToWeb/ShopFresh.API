...
{
    public class BuildBlueberry : IBuilderBlueberry
    {
        ...
        public BuildBlueberry(Guid personId, int countInPackage, int createdDate, float weight)
        {
            PersonId = personId;
        ...
        public SelfBlueberry CreateBlueberry()
        {
            return new SelfBlueberry(this);
        }
    }
}
