using Items.Domain.Components.Entities.Categories.Fruits.ConcreteGrape;
using FruitSelf = Items.Domain.Components.Entities.Categories.Fruits.Fruit.Fruit;

namespace Items.Domain.Components.Entities.Categories.Fruits.ConcreteGrape.Grape
{
