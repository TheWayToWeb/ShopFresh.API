using Items.Domain.Components.Entities.Categories.Fruits.ConcreteBanana;
...
namespace Items.Domain.Components.Entities.Categories.Fruits.ConcreteBanana.Banana
{
