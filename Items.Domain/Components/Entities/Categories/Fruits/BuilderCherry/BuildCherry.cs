...
{
    public class BuildCherry : IBuilderCherry
    {
        ...
        public BuildCherry(Guid personId, int countInPackage, int createdDate, float weight)
        {
            PersonId = personId;
        ...
        public SelfCherry CreateCherry()
        {
            return new SelfCherry(this);
        }
    }
}
