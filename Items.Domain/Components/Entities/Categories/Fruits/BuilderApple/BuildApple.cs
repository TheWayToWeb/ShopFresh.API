...
{
    public class BuildApple : IBuilderApple
    {
        ...
        public BuildApple(Guid personId, int countInPackage, int createdDate, float weight)
        {
            PersonId = personId;
        ...
        public void SetSaleWeights(List<SalesLine> value)
        {
            if (value.Count == 0) return;
            SalesWeights = value;
        }

        public SelfApple CreateApple()
        {
            return new SelfApple(this);
        }
    }
}
