namespace Items.Domain.Components.Entities.Categories.Bakery.FancyCake
{
    public class MakeFancyCake : IMakerFancyCake
    {
        ...
        public string productTypeSelf { get; private set; } = "";
        ...
        public void ProductTypeSelf(string value) => productTypeSelf = value;

        public FancyCake CreateFancyCake()
        {
            return new FancyCake(
                PersonId,
                ItemId,
                itemName,
                price,
