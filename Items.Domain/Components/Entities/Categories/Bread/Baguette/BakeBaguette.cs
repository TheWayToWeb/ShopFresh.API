namespace Items.Domain.Components.Entities.Categories.Bread.Baguette
{
    public class BakeBaguette : BakerBaguette
    {
        ...
        public string GetAddition(string value)
        {
            return _addition!;
        }
        ...
        public override Baguette CreateBaguette()
        {
            return new Baguette(PersonId, ItemId, _itemName, _price, _imagePath);
        }
    }
}
