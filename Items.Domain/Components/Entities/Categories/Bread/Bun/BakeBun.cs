...
namespace Items.Domain.Components.Entities.Categories.Bread.Bun
{
    public class BakeBun : BakerBun
    {
        ...
        public BakeBun(Guid personId, string? itemName, int price, string? imagePath)
        {
            PersonId = personId;
            ItemId = Guid.NewGuid();
            _itemName = itemName;
        ...
        public override Bun CreateBun()
        {
            return new Bun(PersonId, ItemId, _itemName, _price, _imagePath);
        }
    }
}
