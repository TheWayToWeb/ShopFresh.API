namespace Items.Domain.Components.Entities.Categories.Bread.MakingPuff
{
    public class BakePuff : BakerPuff
    {
        ...
        public BakePuff() { }
        public BakePuff(Guid personId, string? itemName, int price, string? imagePath)
        {
            PersonId = personId;
            ItemId = Guid.NewGuid();
            _itemName = itemName;
        ...
        public override Puff CreatePuff()
        {
            return new Puff(PersonId, ItemId, _itemName, _price, _imagePath);
        }
    }
}
