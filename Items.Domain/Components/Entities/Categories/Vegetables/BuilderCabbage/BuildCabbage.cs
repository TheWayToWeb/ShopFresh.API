...
{
    public class BuildCabbage : IBuilderCabbage
    {
        ...
        public BuildCabbage(Guid personId, int countInPackage, int createdDate)
        {
            PersonId = personId;
        ...
        public SelfCabbage CreateCabbage()
        {
            return new SelfCabbage(this);
        }
