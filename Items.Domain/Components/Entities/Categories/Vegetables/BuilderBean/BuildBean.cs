using SelfBean = Items.Domain.Components.Entities.Categories.Vegetables.BuilderBean.Bean.Bean;

namespace Items.Domain.Components.Entities.Categories.Vegetables.BuilderBean
{
    public class BuildBean : IBuilderBean
    {
        ...
        public BuildBean(Guid personId, int countInPackage, int createdDate, float weight)
        {
            PersonId = personId;
        ...
        public SelfBean CreateBean()
        {
            return new SelfBean(this);
        }
    }
}
