using SelfCauliflower = Items.Domain.Components.Entities.Categories.Vegetables.BuilderCauliflower.Cauliflower.Cauliflower;

namespace Items.Domain.Components.Entities.Categories.Vegetables.BuilderCauliflower
{
    public class BuildCauliflower : IBuilderCauliflower
    {
        ...
        public BuildCauliflower(Guid personId, int countInPackage, int createdDate, float weight)
        {
            PersonId = personId;
        ...
        public SelfCauliflower CreateCauliflower()
        {
            return new SelfCauliflower(this);
        }
    }
}
