...
{
    public class BuildTomato : IBuilderTomato
    {
        ...
        public bool IsSlicngShape { get; private set; }
        public string SkinColor { get; private set; } = string.Empty;

        public BuildTomato(Guid personId, int countInPackage, int createdDate, float weight)
        {
            PersonId = personId;
        ...
        public SelfTomato CreateTomato()
        {
            return new SelfTomato(this);
        }
    }
}
