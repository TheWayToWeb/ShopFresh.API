...
{
    public class BuildSaladMix : IBuilderSaladMix
    {
        ...
        public List<SelfSalad> GreeneryKinds { get; private set; } = new();

        public BuildSaladMix(Guid personId, int countInPackage, int createdDate, float weight)
        {
            PersonId = personId;
        ...
        public void AddGreeneryKinds(List<SelfSalad> value)
        {
            if (value.Count == 0) return;
            GreeneryKinds = value;
        }

        public SelfSaladMix CreateSaladMix()
        {
            return new SelfSaladMix(this);
        }
    }
}
