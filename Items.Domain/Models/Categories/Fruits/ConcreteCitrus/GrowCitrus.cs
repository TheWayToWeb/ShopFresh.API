...
{
    public class GrowCitrus : IGrowerCitrus
    {
        ...
        public GrowCitrus(Guid personId, string itemName, float weight)
        {
            this.personId = personId;
            this.itemId = Guid.NewGuid();
