...
namespace Items.Domain.Models.Categories.Fruits.ConcreteBanana
{
    public class GrowBanana : IGrowerBanana
    {
        ...
        public List<Range> saleWeights { get; private set; } = new();
        
        public GrowBanana(Guid personId) {
        ...
        public GrowBanana(Guid personId, string itemName, float weight) {
            this.personId = personId;
            this.itemId = Guid.NewGuid();
        ...
        public void SaleWeight(List<Range> value) => saleWeights = value;

        public BananaDomain CreateBanana() {
            return new BananaDomain(
                personId,
                itemId,
                itemName,
                price,
