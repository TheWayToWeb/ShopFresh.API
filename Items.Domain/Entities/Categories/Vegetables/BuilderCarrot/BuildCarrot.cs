using SelfCarrot = Items.Domain.Entities.Categories.Vegetables.BuilderCarrot.Carrot.Carrot;
using Line = Items.Domain.Entities.Categories.Common.Range;

namespace Items.Domain.Entities.Categories.Vegetables.BuilderCarrot
{
    public class BuildCarrot : IBuilderCarrot
    {
        ...
        public BuildCarrot(Guid personId, int countInPackage, int createdDate) 
        {
            PersonId = personId;
        ...
        public void SetWash(bool value)
        {
            if (!value) return;
            IsWash = value;
        }
        ...
        public SelfCarrot CreateCarrot() {
            return new SelfCarrot(this);
        }
    }
}
