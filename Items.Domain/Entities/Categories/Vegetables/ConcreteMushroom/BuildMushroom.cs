...
{
    public class BuildMushroom : IBuilderMushroom
    {
        ...
        public BuildMushroom(Guid personId, int countInPackage, int createdDate, float weight)
        {
            PersonId = personId;
        ...
        public SelfMushroom CreateMushroom() {
            return new SelfMushroom(this);
        }
    }
}
