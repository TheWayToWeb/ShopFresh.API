using SelfBeet = Items.Domain.Entities.Categories.Vegetables.BuilderBeet.Beet.Beet;

namespace Items.Domain.Entities.Categories.Vegetables.BuilderBeet
{
    public class BuildBeet : IBuilderBeet
    {
        ...
        public BuildBeet(Guid personId, int countInPackage, int createdDate, float weight) {
            PersonId = personId;
        ...
        public SelfBeet CreateBeet() {
            return new SelfBeet(this);
        }
    }
}
