...
namespace Items.Domain.Entities.Categories.Vegetables.ConcreteSalad
{
    public class BuildSalad : IBuilderSalad
    {
        ...
        public BuildSalad(Guid personId, int countInPackage, int createdDate, float weight) 
        {
            PersonId = personId;
        ...
        public SelfSalad CreateSalad() {
            return new SelfSalad(this);
        }
    }
}
