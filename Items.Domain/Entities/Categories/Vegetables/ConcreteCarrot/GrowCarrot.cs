...
{
    public class GrowCarrot : IGrowerCarrot
    {
        ...
        public GrowCarrot(Guid personId, int countInPackage, int createdDate, float weight) {
            PersonId = personId;
        ...
        public carrotDomain CreateCarrot() {
            return new carrotDomain(this);
        }
    }
}
