...
namespace Items.Domain.Models.Categories.Bread.MakingSingleFood
{
    public class MakeSingleFood : MakerSingleFood
    {
        ...
        public MakeSingleFood() { }
        public MakeSingleFood(Guid personId, string? itemName, int price, string? imagePath)
        {
            PersonId = personId;
            ItemId = Guid.NewGuid();
            _itemName = itemName;
        ...
        public override SingleFood CreateSingleFood()
        {
            return new SingleFood(PersonId, ItemId, _itemName, _price, _imagePath);
        }
    }
}
