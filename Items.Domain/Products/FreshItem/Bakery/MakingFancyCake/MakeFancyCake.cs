...
{
    public class MakeFancyCake : MakerFancyCake
    {
        ...
        private string? _productTypeItSelf { get; set; } = "";

        public MakeFancyCake() {}
        ...
        public void SetProductTypeItSelf(string value) {
            _productTypeItSelf = value;
        }

        public string GetProductTypeItSelf() {
            return _productTypeItSelf!;
        }

        public override FancyCake CreateFancyCake() {
            return new FancyCake(PersonId, ItemId, _itemName, _price, _imagePath);
        }
    }
}
