...
{
    public class MakePackageTea : MakerPackageTea
    {
        ...
        public string  kindOfTea { get; private set; } = "";
        public int  sashetCount { get; private set; } = 0;

        public MakePackageTea() { 
        }

        public MakePackageTea(Guid personId, string itemName, int price, string imagePath) {
                PersonId = personId;
                ItemId = Guid.NewGuid();
        ...
        public void KindOfTea(string value) =>  kindOfTea = value;
        public void SashetCount(int value) =>  sashetCount = value;

        public override PackageTea CreateDryTea()
        {
            return new PackageTea(
                PersonId,
                ItemId,
                itemName,
                price,
