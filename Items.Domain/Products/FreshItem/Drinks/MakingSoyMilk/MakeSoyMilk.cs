...
{
    public class MakeSoyMilk : MakerSoyMilk
    {
        ...
        public string _kindOfMilk { get; private set; } = "";

        public MakeSoyMilk() { }

        public MakeSoyMilk(Guid personId, string itemName, int price, string imagePath) {
            PersonId = personId;
            ItemId = Guid.NewGuid();
            _itemName = itemName;
            _price = price;
        ...
        public void KindOfMilk(string value) => _kindOfMilk = value;
        
        public override SoyMilk CreateSoyMilk()
        {
            return new SoyMilk(PersonId, ItemId, _itemName, _price, _imagePath);
        }
    }
}
