...
namespace Items.Domain.Products.FreshItem.Drinks.MakingEnergyDrink
{
    public class MakeEnergyDrink : MakerEnergyDrink
    {
        ...
        public List<SaleStatus> _sales { get; private set; } = new();
        public float _coffein { get; private set; } = 0;
        ...
        public void SaleStatus(List<SaleStatus> value) => _sales.AddRange(value);
        public void Coffein(float value) => _coffein = value;
        ...
        {
            return new EnergyDrink(PersonId, ItemId, _itemName, _price, _imagePath);
        }
    }
}
